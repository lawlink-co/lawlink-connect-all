...
const slides: CarouselSlide[] = [
  ...
  },
  {
    ...
    description: "Behind the interface is a layered system built for volume and precision. From intake to resolution, every document, update, and deadline connects across one living database — your firm's new operating system. Build your perfect CRM by adding or removing pages, fields, and contacts. Drag, drop, and organize your workspace, save custom layouts as templates, and control access with permissions.",
