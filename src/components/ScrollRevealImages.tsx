...
const ScrollRevealImages = () => {
  ...
  return (
    <div className="relative w-full max-w-4xl mx-auto py-24 overflow-visible">
      ...
      <div 
        className={`absolute top-[15%] left-[-2%] z-10 transition-all duration-700 ease-out
      ...
      <div 
        className={`absolute top-[15%] right-[-2%] z-10 transition-all duration-700 ease-out
          ${isVisible ? 'rotate-12 opacity-100 translate-x-0' : 'rotate-6 opacity-0 translate-x-12'}`}
      ...
      <div 
        className={`absolute bottom-[15%] left-[0%] z-10 transition-all duration-700 ease-out
      ...
      <div 
        className={`absolute bottom-[15%] right-[0%] z-10 transition-all duration-700 ease-out
          ${isVisible ? 'rotate-6 opacity-100 translate-x-0' : 'rotate-3 opacity-0 translate-x-12'}`}
